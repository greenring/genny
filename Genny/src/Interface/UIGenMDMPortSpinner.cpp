...
UIGenMDMPortSpinner::UIGenMDMPortSpinner(CPoint point, GennyInterfaceObject* owner):
...
UIGenMDMPortSpinner::~UIGenMDMPortSpinner(void)
{

}

bool UIGenMDMPortSpinner::attached (CView* parent)
{
...
void UIGenMDMPortSpinner::setValue(float val)
{
	...
	_vst->genMDMPort = (int)getValue();
}

void UIGenMDMPortSpinner::valueChanged (CControl* control)
{
...
void UIGenMDMPortSpinner::draw (CDrawContext* pContext)
{
	CControl::setDirty(false);
}

void UIGenMDMPortSpinner::reconnect()
{
	setValue(_vst->genMDMPort);
}

void UIGenMDMPortSpinner::setVisible(bool visible)
{
...
bool UIGenMDMPortSpinner::onWheel (const CPoint& where, const CMouseWheelAxis& axis, const float& distance, const CButtonState& buttons)
{
