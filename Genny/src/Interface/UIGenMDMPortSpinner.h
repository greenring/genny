...
class UIGenMDMPortSpinner : public CControl, public IControlListener, public GennyInterfaceObject
{
public:
	UIGenMDMPortSpinner(CPoint point, GennyInterfaceObject* owner);
	~UIGenMDMPortSpinner(void);
	...
	CLASS_METHODS(UIGenMDMPortSpinner, CControl)
